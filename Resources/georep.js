...
var dbConfValidator = function(dbc) {
    if (dbc) {
        if (dbc.name && "string" == typeof dbc.name && dbc.host && "string" == typeof dbc.host && dbc.proto && "string" == typeof dbc.proto && dbc.admin && dbc.admin instanceof Admin && dbc.port && "number" == typeof dbc.port && !(0 >= dbc.port) && !(dbc.port >= 65536)) return true;
        throw {
...
var adminConfValidator = function(ac) {
    if (ac) {
        if (ac.name && "string" == typeof ac.name && ac.password && "string" == typeof ac.password) return true;
        throw {
